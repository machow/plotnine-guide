...
* Aesthetics mapped to the same variable sometimes have their guides merged.
* To split a merged legend, give the scales their own names.
...
p + theme(legend_position = "bottom")
...
p = ggplot(df, aes("x", "y", colour="p", size="q", shape="r")) + geom_point()
