...
* How to create a sequence of subplots.
* How to create a matrix of subplots.
* How to configure the x- and y-axis of subplots.
* How to customize the labels of subplots.
:::
...
TODO: example of more complex facet grid and facet wrap.
